...
build_dst = fend_p4_root + 'build/pizza_app/'
...
build = ->        
    fs.writeFileSync(build_dst + 'index_dist.html', pages.index_dist.render())
    fs.writeFileSync(build_dst + 'index_develop.html', pages.index_develop.render())
